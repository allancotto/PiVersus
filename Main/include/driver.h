...
//FXOS8700 registers for data (data is a 14 bit word, 8 in msb and 6 in lsb - lsb has to be shifted >> 2)
#define OUT_x_MSB 0x01
#define OUT_x_LSB 0x01
#define OUT_Y_MSB 0x01
#define OUT_Y_LSB 0x01
#define OUT_Z_MSB 0x01
#define OUT_Z_LSB 0x01
